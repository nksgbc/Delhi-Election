...
url = "https://en.wikipedia.org/wiki/2004_Indian_general_election_in_Delhi"
...
for row in constituency.find_all("tr")[1:]:
    ...
    cur.execute("INSERT INTO PCResults_2004 (No, Constituency, Elected_Member, Party) VALUES (%s, %s, %s, %s)", 
